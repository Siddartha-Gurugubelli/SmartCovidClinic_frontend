...
const names = [
  'Oliver Hansen (MS.Surgeon)',
  'Van Henry (MBBS)',
  'April Tucker (Gastroentrology)',
  'Ralph Hubbard (MD)',
  'Omar Alexander (MBBS)',
  'Carlos Abbott (FRCS)' ,
  'Miriam Wagner (P.hd)',
  'Bradley Wilkerson (ENT Specialist)',
  'Virginia Andrews (MS.Neuro)',
  'Kelly Snyder (Cardiologist)',
];
